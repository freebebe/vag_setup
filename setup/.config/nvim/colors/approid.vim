...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi CursorLineNr ctermbg=236 ctermfg=73 cterm=NONE guibg=#2d2d2d guifg=#5fafaf gui=NONE
    hi CursorLine ctermbg=236 ctermfg=NONE cterm=NONE guibg=#2d2d2d guifg=NONE gui=NONE
